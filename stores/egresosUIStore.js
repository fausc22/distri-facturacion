...
export const useEgresosUIStore = create((set) => ({
  ...
  modales: { nuevoEgreso: false, detalle: false },
  ...
  loading: { egresos: false, cuentas: false, operacion: false },
  setLoading: (partial) =>
    set((s) => ({ loading: { ...s.loading, ...partial } })),
}));

export default useEgresosUIStore;
